...
```
┌─ 故障录波查询 ──────────────────────────────────────────────────────────────────────┐
│ 记录可读数: [15]  │ 记录编号: [0▼] (0=最新记录) │[查询目录]  [查询详情]  [取消]  [清除记录]│
└───────────────────────────────────────────────────────────────────────────────────┘
```
横排显示
#### 3.7.3 故障信息显示
...
```
故障发生时间: 2025-10-01 13:45:12.345|故障码: [0x0001]|
故障描述: 1段电压保护等。。。。。。
```
分为两横排显示
#### 3.7.4 数据表格
...
| ------------ | ----- | ----------------------- |
| 序号         | 60px  | 0-299                    |
| 系统状态      | 80px | 0xXXXX,点击弹出解析对话框   |
| 开关量输入    | 80px | 0xXXXX,点击弹出解析对话框    |
| 开关量输出    | 80px | 0xXXXX,点击弹出解析对话框    |
| SV1         | 80px | 数值+单位                  |
| SV2         | 80px | 数值+单位                  |
| SA1         | 80px  | 数值+单位                  |
| SA2         | 80px  | 数值+单位                  |
